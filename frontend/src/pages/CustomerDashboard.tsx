...
export default function CustomerDashboard() {
  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] flex font-sans">
      ...
      {/* --- SIDEBAR NAVIGATION --- */}
      <aside className="w-64 bg-white border-r border-slate-100 flex flex-col shrink-0 text-left pt-6">
        ...
        {activeTab === "Dashboard" && (
          <div className="space-y-8 animate-in fade-in duration-200">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              {/* Metric 1 */}
              <div className="bg-white border border-slate-100 rounded-2xl p-4 shadow-sm flex items-center justify-between hover:shadow-md transition-all">
                <div className="flex items-center gap-4">
                  <div className="w-12 h-12 rounded-xl bg-red-50/70 text-red-500 flex items-center justify-center">
                    <ShoppingBag className="w-6 h-6" />
                  </div>
                  <div>
                    <h3 className="text-2xl font-black text-slate-800">{totalOrdersCount}</h3>
                    <span className="text-[10px] text-slate-450 font-bold block uppercase tracking-wider mt-0.5">Total Orders</span>
                  </div>
                </div>
                <button onClick={() => setActiveTab("My Orders")} className="text-red-500 hover:text-red-600 font-bold text-[10px] uppercase tracking-wider flex items-center gap-0.5">
              ...
              <div className="bg-white border border-slate-100 rounded-2xl p-4 shadow-sm flex items-center justify-between hover:shadow-md transition-all">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <span className="text-[10px] text-slate-455 font-bold block uppercase tracking-wider mt-0.5">In Progress</span>
                  </div>
                </div>
                <button onClick={() => setActiveTab("My Orders")} className="text-emerald-650 hover:text-emerald-700 font-bold text-[10px] uppercase tracking-wider flex items-center gap-0.5">
                  <span>Track</span> <ArrowRight className="w-3.5 h-3.5" />
                </button>
              </div>
              ...
              <div className="bg-white border border-slate-100 rounded-2xl p-4 shadow-sm flex items-center justify-between hover:shadow-md transition-all">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <span className="text-[10px] text-slate-450 font-bold block uppercase tracking-wider mt-0.5">Completed Orders</span>
                  </div>
                </div>
                <button onClick={() => setActiveTab("My Orders")} className="text-amber-605 hover:text-amber-700 font-bold text-[10px] uppercase tracking-wider flex items-center gap-0.5">
                  <span>History</span> <ArrowRight className="w-3.5 h-3.5" />
                </button>
              </div>
              ...
              <div className="bg-white border border-slate-100 rounded-2xl p-4 shadow-sm flex items-center justify-between hover:shadow-md transition-all">
                <div className="flex items-center gap-4">
                  ...
                  <div>
                    ...
                    <span className="text-[10px] text-slate-450 font-bold block uppercase tracking-wider mt-0.5">Active AMC Plan</span>
                  </div>
                </div>
                <button onClick={() => setActiveTab("AMC Plans")} className="text-purple-650 hover:text-purple-700 font-bold text-[10px] uppercase tracking-wider flex items-center gap-0.5">
